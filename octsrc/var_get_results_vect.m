...
%
% Example:
%  [r,v,par_val,par_name,info_str] = var_get_results_vect(res,par,vr)
%  [r,v,par_val,par_name,info_str] = var_get_results_vect(res,par,vr,name)
%  [r,v,par_val,par_name,info_str] = var_get_results_vect(res,par,vr,name,options)
%
% Parameters:
